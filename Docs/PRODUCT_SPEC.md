...
- **Snapping stays exactly as it is** (founder, 2026-09-26: "I don't want it more sticky"). The "wall sticking out" he saw in 3D was a corner he simply needed to move a little; the fix is the moving/nudging above, not stronger snapping. The `dangling-vertex` issue row reads "Corner is not joined to anything — click to find it".
